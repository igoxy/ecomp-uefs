clc; clear; close;
% Projeto de filtro FIR com janela de Bartlett (triangular) - Resposta Finita ao Impulso
...
% Encontrando o comprimento da janela de Triangular
...
window_bartlett = myTriangular(N)'; % Criando a função janela de Retangular

%Janelando o sinal
hd_sinc_window = hd_sinc.*window_bartlett;
...
audiowrite("./Audio_Triangular/SinalRuidoso_filtrado_triangular.wav", sinal_reconstruido_normalizado, fs_sinal)