clc; clear; close;
% Projeto de filtro FIR com janela de Hamming - Resposta Finita ao Impulso
...
% Encontrando o comprimento da janela de Hamming
% Através da equação: N = (3.3*pi*2)/wt
...
window_hamming = myHamming(N)'; % Criando a função janela de Hamming

%Janelando o sinal
hd_sinc_window = hd_sinc.*window_hamming;
...
audiowrite("./Audio_Hamming/SinalRuidoso_filtrado_hamming.wav", sinal_reconstruido_normalizado, fs_sinal)