clc; clear; close;
% Projeto de filtro FIR com janela de Hanning - Resposta Finita ao Impulso
...
% Encontrando o comprimento da janela de Hanning
...
window_hanning = myHann(N)'; % Criando a função janela de Hanning

%Janelando o sinal
hd_sinc_window = hd_sinc.*window_hanning;
...
audiowrite("./Audio_Hanning/SinalRuidoso_filtrado_hanning.wav", sinal_reconstruido_normalizado, fs_sinal)