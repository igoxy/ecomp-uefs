clear; clc;
%Código para a simulação da amostragem PAM natural FORA do
%critério de Nyquist.
...
% Aplicando amostragem em DESACORDO com o teorema de Nyquist
freq_amostragem = 25; % Maior frequência após filtragem: 20 Hz | freq_amostragem <= 40  
ampl_pulso = 1;
