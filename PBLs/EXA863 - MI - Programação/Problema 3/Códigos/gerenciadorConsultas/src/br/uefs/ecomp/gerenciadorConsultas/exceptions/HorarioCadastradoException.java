 ...
 * a criação de um novo horário para a marcação de consulta e o horário já apresentar-se
 * cadastrado no sistema.
 * 
 * @author Igor
 */
public class HorarioCadastradoException extends Exception{
    ...
    public String getMessage(){
        return "O horário inserido já foi cadastrado";        
    }
}
