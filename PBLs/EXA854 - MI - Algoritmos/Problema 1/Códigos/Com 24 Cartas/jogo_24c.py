...
while opcao != "3": #Entrada nas opções do jogo 
    ...
    if opcao == "1": #Entrada no jogo
        ...
        carta1 = [None]*4; carta2 = [None]*4; carta3 = [None]*4; carta4 = [None]*4; carta5 = [None]*4; carta6 = [None]*4
        """ Nome das cartas (os nomes monstros são temporários) """
        nome_cartas = ["Monstro 1", "Monstro 2", "Monstro 3", "Monstro 4", "Monstro 5", "Monstro 6", "Monstro 7", "Monstro 8",]
        nome_cartas += ["Monstro 9", "Monstro 10", "Monstro 11", "Monstro 12", "Monstro 13", "Monstro 14", "Monstro 15", "Monstro 16",]
        nome_cartas += ["Monstro 17", "Monstro 18", "Monstro 19", "Monstro 20", "Monstro 21", "Monstro 22", "Monstro 23", "Monstro 24",]
        ...
        while rodadas > 0: #Início das rodadas (e do jogo propriamente dito)
            ...
            random.shuffle(nome_cartas)           #Embaralha as cartas
            for i in range(6):                #Atribui os nomes as cartas que serão distribuídas para os jogadores
                cartas[i][3] = nome_cartas[i]
            ...
            while  verificador < 2: #Laço para garantir que todos os jogadores joguem na rodada
                if jogador == 1: #Estrutura para a vez de jogar do jogador 1
                    ...
                    print("{:=^50}".format(" Cartas do jogador {} ").format(jogador1[3]),"\n")
                    for item in jogador1[0:3]: #Imprime suas cartas e seus atributos para o jogador 1
                        print("\n{:-^50}".format(" Carta {} ").format(cont3 + 1))
                        print("\n\t\t{} - {}\n".format(jogador1[cont3][3], jogador1[3]))
                ...
                if jogador == 2: #Estrutura para a vez de jogar do jogador 1
                    cont3 = 0 #Contador auxiliar para percorrer elementos dentro das listas (jogador1 e jogador2) 
                    print("{:=^50}".format(" Cartas do jogador {} ").format(jogador2[3]),"\n")
                    for item in jogador2[0:3]: #Imprime suas cartas e seus atributos para o jogador 2
                        print("\n{:-^50}".format(" Carta {} ").format(cont3 + 1))
                        print("\n\t\t{} - {}\n".format(jogador2[cont3][3],jogador2[3]))    
                        print("\t\tAtributo 1: ".format(), jogador2[cont3][0])
